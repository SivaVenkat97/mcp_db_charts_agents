...
class SqlQuery(Base):
    ...
    query_type = Column(String(50), nullable=True)  # SELECT, INSERT, UPDATE, DELETE, etc.
    execution_time = Column(Float, nullable=True)  # Query execution time in seconds
    rows_affected = Column(Integer, nullable=True)  # Number of rows affected
    status = Column(String(20), nullable=True)  # SUCCESS, ERROR, etc.
